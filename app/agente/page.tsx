...
import {
  ...
  CheckSquare2, ArrowRight, BookOpen,
} from "lucide-react"
...
interface Plano {
  ...
  calendario:   Array<{ dia: number; tema: string; formato: string }>
}
            ...
            {!planejando && plano && (
              <>
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    onClick={() => { setStage("briefing"); setPlano(null) }}
              ...
              <div className="flex items-center gap-2 flex-wrap">
                ...
                >
                  {saving
                    ...
                    : allSaved
                      ? <><Check className="w-3.5 h-3.5" /> Tudo salvo!</>
                ...
                <button
                  onClick={() => setExpandedDays(dias.map(d => d.dia))}
                            ...
                            <div className="space-y-4">
                              ...
                              <div className="bg-background border border-border rounded-lg p-4 space-y-3">
                                <div>
                                  ...
                                  <button
                                    onClick={() => navigator.clipboard.writeText(d.imagem.prompt).then(() => showToast("Prompt copiado!"))}
                              ...
                              <div>
                                ...
                                <div className="flex flex-wrap gap-1.5">
                                  {(d.legenda.hashtags ?? []).map((h, hi) => (
                                    <span key={hi} className="text-[10px] font-mono px-2.5 py-1 rounded-full border border-blue-500/30 bg-blue-950/30 text-blue-400">
                                      {h}
                                    </span>
                                  ))}
                                </div>
