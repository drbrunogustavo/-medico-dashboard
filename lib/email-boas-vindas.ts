export const APP_URL    = process.env.NEXT_PUBLIC_APP_URL ?? "https://praxisplataforma.com.br"
export const FROM_EMAIL = process.env.EMAIL_FROM          ?? "PRAXIS <onboarding@resend.dev>"
export const REPLY_TO   = process.env.EMAIL_REPLY_TO      ?? "contato@praxisplataforma.com.br"

export function buildBoasVindasHtml(nome: string): string {
