...
import {
  ...
  MessageSquare, Search, BookOpen, TrendingUp,
} from "lucide-react"
...
const NAV = [
  {
    category: null, // sem header — item único
    items: [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Análise de Concorrentes",href: "/analise",     icon: Search,        badge: null   },
    ]
  },
  {
          ...
          <div key={gi} className={gi > 0 ? "pt-2" : ""}>
            ...
            {group.category && (
              <div className="flex items-center gap-2 px-2 mb-1.5 mt-1">
                <div className="text-[9px] font-mono text-text-muted tracking-widest uppercase flex-1">
                  {group.category}
                </div>
