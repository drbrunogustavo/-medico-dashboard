...
const TIPO_STYLE: Record<string, string> = {
  ...
  "Pergunta":   "bg-blue-950/60 border-blue-500/40 text-blue-400",
  "Benefício":  "bg-amber-950/60 border-amber-500/40 text-amber-400",
  "Urgência":   "bg-red-950/60 border-red-500/40 text-red-400",
}
